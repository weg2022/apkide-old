...
public class LongLongMap implements Storeable, Serializable {


	private static final long serialVersionUID = 7996631897793449432L;
	...
	public void insert(@NonNull LongLongMap map) {
	...
	private void rehash() {
		...
		if (count * 2 > keys.length) {
			...
			newValues = new long[SIZES[sizeExp]];
	...
	public void restore(@NonNull StoreInputStream in) throws IOException {
		...
		for (int i = 0; i < size; i++) {
			insert(in.readLong(), in.readLong());
		}
	}
	...
	public boolean equals(Object o) {
		...
		LongLongMap intIntMap = (LongLongMap) o;
