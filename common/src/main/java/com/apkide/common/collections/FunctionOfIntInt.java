...
public class FunctionOfIntInt {
   ...
   public FunctionOfIntInt(@NonNull StoreInputStream stream) throws IOException {
      super();
   ...
   public void put(@NonNull FunctionOfIntInt set) {
   ...
   public class Iterator {
      ...
      public boolean hasMoreElements() {
         while(this.index < FunctionOfIntInt.this.myKeys.length) {
            this.key = FunctionOfIntInt.this.myKeys[this.index];
            if (this.key != 0 && this.key != MIN_VALUE) {
               if (this.key == MAX_VALUE) {
                  this.key = 0;
               }

               this.value = FunctionOfIntInt.this.myValues[this.index];
               ++this.index;
               return true;
            }
