...
public class YamlCodeRefactor implements CodeRefactor {
    private final YamlLanguage myLanguage;
    
    public YamlCodeRefactor(YamlLanguage language) {
        myLanguage = language;
    }
    ...
    @Override
    public void removeCommentLines(@NonNull String filePath, int startLine,
