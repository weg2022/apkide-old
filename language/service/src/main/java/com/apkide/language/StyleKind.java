...
public class StyleKind {
    ...
    public static final int VariableStyle = 10;
    public static final int FunctionStyle = 11;
    public static final int FunctionCallStyle = 12;
    public static final int ParameterStyle = 13;
    public static final int CommentStyle = 14;
    public static final int BlockCommentStyle = 15;
