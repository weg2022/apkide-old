...
public class CodeAnalysisService extends Service {
    ...
    private CodeAnalysisEngine myEngine = new CodeAnalysisEngine();
    private final Binder myBinder = OkBinder.create(new ICodeAnalysisService() {
        ...
        public void setHighlightingListener(@NonNull IHighlightingListener listener) {
            myEngine.setHighlightingListener(new HighlightingListener() {
                @Override
                public void fileHighlighting(@NonNull String filePath, int[] styles,
                ...
                @Override
                public void semanticHighlighting(@NonNull String filePath, int[] styles,
                                                 int[] startLines, int[] startColumns,
                                                 int[] endLines, int[] endColumns, int size) {
                    myHighlighting.filePath = filePath;
                    myHighlighting.styles = styles;
                ...
                private final FileHighlights myHighlighting = new FileHighlights();
                
            });
        }
        
        @Override
        public void setFindAPIListener(@NonNull IFindAPIListener listener) {
        
        }
        
        @Override
        public void setFindUsagesListener(@NonNull IFindUsagesListener listener) {
