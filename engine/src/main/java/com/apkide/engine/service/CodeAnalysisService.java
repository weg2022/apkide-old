...
import com.apkide.engine.Engine;
import com.apkide.engine.FileHighlighting;
import com.apkide.engine.HighlightingListener;
...
public class CodeAnalysisService extends Service {
    ...
    private final Engine myEngine = new Engine();
    private final Binder myBinder = InterfaceService.newService(
            ...
            new ICodeAnalysisService() {
                ...
                @Override
                public void setCompilationListener(@NonNull ICompilationListener listener) {
