    ...
    public abstract class DragHandle {
        ...
        public void draw(Canvas canvas) {
            if (isVisible) {
                ...
                if (isDown) {
                    if (getCodeEditText().getDragHandleDownColor() != 0)
                        iconDown.setTint(getCodeEditText().getDragHandleDownColor());
                    iconDown.setBounds(handleRectInWindow);
                    iconDown.draw(canvas);
                    return;
                }
                if (getCodeEditText().getDragHandleColor() != 0)
                    icon.setTint(getCodeEditText().getDragHandleColor());
