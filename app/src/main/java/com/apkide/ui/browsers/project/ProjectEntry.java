...
public class ProjectEntry implements Entry ,Comparable<ProjectEntry>{
    ...
    public ProjectEntry(BrowserMenuCommand command) {
        this.filePath = null;
        myCommand = command;
    ...
    public ProjectEntry(@NonNull String filePath) {
    ...
    public ProjectEntry(@NonNull String filePath, @NonNull String label, boolean isDirectory) {
        this.filePath = filePath;
        this.label = label;
        ...
        if (isDirectory) {
            ...
            this.isHidden = false;
            icon = ProjectFileIcons.getIcon(filePath);
        }
        iconDrawable = ProjectFileIcons.getIconDrawable(filePath);
    }
