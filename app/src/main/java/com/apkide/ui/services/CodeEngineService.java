...
public class CodeEngineService implements IService {
    private final ServiceConnection myConnection = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            myService = OkBinder.proxy(ICodeAnalysisService.class, service);
            AppLog.s(CodeEngineService.class, "Service Connected.");
            restart();
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            myService = null;
            AppLog.s(CodeEngineService.class, "Service Disconnected.");
        }
    };
