...
import com.apkide.java.decompiler.modules.decompiler.exps.IfExprent;
import com.apkide.java.decompiler.modules.decompiler.exps.InvocationExprent;
import com.apkide.java.decompiler.modules.decompiler.exps.MonitorExprent;
...
import com.apkide.java.decompiler.modules.decompiler.StatEdge.EdgeType;
import com.apkide.java.decompiler.modules.decompiler.sforms.DirectGraph;
import com.apkide.java.decompiler.modules.decompiler.sforms.DirectNode;
import com.apkide.java.decompiler.modules.decompiler.sforms.FlattenStatementsHelper;
import com.apkide.java.decompiler.modules.decompiler.sforms.FlattenStatementsHelper.FinallyPathWrapper;
...
public class ExprProcessor implements CodeConstants {
      ...
      switch (instr.opcode) {
        ...
        case opc_invokedynamic:
          if (instr.opcode != opc_invokedynamic || instr.bytecodeVersion >= BYTECODE_JAVA_7) {
            ...
            if (exprinv.getDescriptor().ret.getType() == TYPE_VOID) {
  ...
  public static boolean getCastedExprent(Exprent exprent,
    ...
    boolean cast =
      castAlways ||
      (!leftType.isSuperset(rightType) && (rightType.equals(VarType.VARTYPE_OBJECT) || leftType.getType() != TYPE_OBJECT)) ||
      (castNull && rightType.getType() == TYPE_NULL && !UNDEFINED_TYPE_STRING.equals(getTypeName(leftType, Collections.emptyList()))) ||
