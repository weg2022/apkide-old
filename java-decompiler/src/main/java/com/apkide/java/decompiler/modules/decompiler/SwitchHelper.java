...
import com.apkide.java.decompiler.modules.decompiler.exps.ArrayExprent;
...
import com.apkide.java.decompiler.modules.decompiler.exps.SwitchExprent;
import com.apkide.java.decompiler.modules.decompiler.exps.VarExprent;
import com.apkide.java.decompiler.struct.gen.VarType;
import com.apkide.java.decompiler.ClassNameConstants;
...
import com.apkide.java.decompiler.modules.decompiler.stats.SwitchStatement;
...
public final class SwitchHelper {
   ...
   */
  public static void simplifySwitchOnEnum(@NonNull SwitchStatement switchStatement) {
    ...
    List<List<Exprent>> realCaseValues = findRealCaseValues(caseValues, mapping);
   ...
   */
  public static void simplifySwitchesOnString(@NonNull RootStatement root) {
  ...
  private static void collectSwitchesOnString(@NonNull Statement statement,
                                              @NonNull List<SwitchRecognizer> recognizers,
                                              @NonNull List<SwitchOnStringCandidate> candidates) {
  ...
  @NonNull
  private static Map<Exprent, Exprent> evaluateCaseLabelsToFieldsMapping(@NonNull List<List<Exprent>> caseValues,
                                                                         @NonNull ArrayExprent array) {
  ...
  @Nullable
  private static List<List<Exprent>> findRealCaseValues(@NonNull List<List<Exprent>> caseValues,
                                                                  @NonNull Map<Exprent, Exprent> mapping) {
    List<List<Exprent>> result = new ArrayList<>(caseValues.size());
  ...
  static void removeTempVariableDeclarations(@NonNull Map<VarExprent, Statement> tempVarAssignments) {
  ...
  private abstract static class SwitchRecognizer {
    ...
    @Nullable
    abstract SwitchOnStringCandidate recognize(@NonNull SwitchStatement statement, @NonNull InvocationExprent switchSelector);

    @NonNull
    Set<Object> findRealCaseValuesHashCodes(@NonNull SwitchStatement switchStatement) {
    ...
    @Nullable
    String findRealCaseValue(@NonNull IfStatement ifStatement, @NonNull Exprent selectorQualifier) {
    ...
    private static class JavacRecognizer extends SwitchRecognizer {
      ...
      @Nullable
      @Override
      public SwitchOnStringCandidate recognize(@NonNull SwitchStatement firstSwitch,
                                               @NonNull InvocationExprent switchSelector) {
    ...
    private static class EcjRecognizer extends SwitchRecognizer {
      @Nullable
      @Override
      public SwitchOnStringCandidate recognize(@NonNull SwitchStatement switchStatement, @NonNull InvocationExprent switchSelector) {
        if (!switchSelector.isInstanceCall(ClassNameConstants.JAVA_LANG_STRING, "hashCode", 0)) return null;
  ...
  private abstract static class SwitchOnStringCandidate {
    ...
    @Nullable
    private static AssignmentExprent addTempVarAssignment(@NonNull Exprent exprent,
    ...
    private static class JavacSwitchCandidate extends SwitchOnStringCandidate {
      @NonNull private final SwitchStatement firstSwitch;
      @NonNull private final VarExprent firstSwitchSelector;
      @NonNull private final VarExprent tmpVarInFirstSwitch;
      @NonNull private final SwitchStatement secondSwitch;
      @NonNull private final Map<Integer, String> mappedCaseLabelValues;

      JavacSwitchCandidate(@NonNull SwitchStatement firstSwitch,
                           @NonNull VarExprent firstSwitchSelector,
                           @NonNull VarExprent tmpVarInFirstSwitch,
                           @NonNull SwitchStatement secondSwitch,
                           @NonNull Map<Integer, String> mappedCaseLabelValues) {
      ...
      @Override
      void simplify(@NonNull Map<VarExprent, Statement> tempVarAssignments) {
    ...
    private static class EcjSwitchCandidate extends SwitchOnStringCandidate {
      @NonNull private final SwitchStatement switchStatement;
      @NonNull private final Exprent switchSelector;
      @NonNull private final VarExprent tmpVar;
      @NonNull private final Map<Integer, IfStatement> mappedIfStatements;
      @NonNull private final Map<Integer, String> mappedCaseLabelValues;

      private EcjSwitchCandidate(@NonNull SwitchStatement switchStatement,
                                 @NonNull Exprent switchSelector,
                                 @NonNull VarExprent tmpVar,
                                 @NonNull Map<Integer, IfStatement> mappedIfStatements,
                                 @NonNull Map<Integer, String> mappedCaseLabelValues) {
      ...
      private static void removeOuterBreakEdge(@NonNull IfStatement ifStatement) {
