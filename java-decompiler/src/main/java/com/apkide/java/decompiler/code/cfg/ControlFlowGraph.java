...
package com.apkide.java.decompiler.code.cfg;

import com.apkide.java.decompiler.code.interpreter.InstructionImpact;
...
import com.apkide.java.decompiler.struct.gen.DataPoint;
...
import com.apkide.java.decompiler.code.JumpInstruction;
      ...
      for (int j = 0; j < 2; j++) {
        ...
        for (int i = lst.size() - 1; i >= 0; i--) {
          ...
          if (mapNewNodes.containsKey(childid)) {
            ...
            // copy all successors
            if (copy.getLastInstruction().opcode == opc_ret && child.getSuccessors().contains(ret)) {
