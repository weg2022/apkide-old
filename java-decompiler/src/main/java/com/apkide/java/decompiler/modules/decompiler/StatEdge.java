...
public class StatEdge {
  ...
  public StatEdge(@NonNull EdgeType type, Statement source, Statement destination, Statement closure) {
    this(type, source, destination);
    this.closure = closure;
  }

  public StatEdge(@NonNull EdgeType type, Statement source, Statement destination) {
    this.type = type;
    this.source = source;
  ...
  public @NonNull EdgeType getType() {
    return type;
  }
  public void setType(@NonNull EdgeType type) {
    this.type = type;
  }
  ...
  public interface EdgeType {
    ...
    EdgeType ALL = new EdgeType() {
      ...
      @NonNull
      @Override
      public EdgeType unite(@NonNull EdgeType other) {
        return this;
      }
    ...
    default @NonNull EdgeType unite(@NonNull EdgeType other) {
      return new EdgeType() {
        @Override
        public int mask() {
