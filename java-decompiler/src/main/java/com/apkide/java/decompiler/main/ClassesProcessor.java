...
import com.apkide.java.decompiler.main.collectors.BytecodeSourceMapper;
import com.apkide.java.decompiler.main.collectors.ImportCollector;
...
import com.apkide.java.decompiler.main.extern.IIdentifierRenamer;
import com.apkide.java.decompiler.main.rels.ClassWrapper;
import com.apkide.java.decompiler.main.rels.LambdaProcessor;
import com.apkide.java.decompiler.main.rels.NestedClassProcessor;
import com.apkide.java.decompiler.main.rels.NestedMemberAccess;
...
import com.apkide.java.decompiler.struct.StructContext;
import com.apkide.java.decompiler.struct.StructMethod;
import com.apkide.java.decompiler.struct.attr.StructEnclosingMethodAttribute;
...
import com.apkide.java.decompiler.struct.attr.StructInnerClassesAttribute;
...
public class ClassesProcessor implements CodeConstants {
            ...
            if (setNestedClasses != null) {
              ...
              for (StructInnerClassesAttribute.Entry entry : inner.getEntries()) {
                ...
                if (nestedNode.type == ClassNode.CLASS_ANONYMOUS) {
                  ...
                  nestedNode.access &= (ACC_ABSTRACT | ACC_FINAL);
                }
  ...
  public void writeClass(StructClass cl, TextBuffer buffer) throws IOException {
    ...
    boolean moduleInfo = cl.hasModifier(ACC_MODULE) && cl.hasAttribute(StructGeneralAttribute.ATTRIBUTE_MODULE);
  ...
  public static class ClassNode {
    ...
    public ClassNode(String content_class_name,
      ...
      lambdaInformation.is_content_method_static =
        (lambdaInformation.content_method_invocation_type == CONSTANT_MethodHandle_REF_invokeStatic); // FIXME: redundant?
    }
