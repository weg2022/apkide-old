...
import com.apkide.java.decompiler.modules.decompiler.DecHelper;
...
import com.apkide.java.decompiler.code.SwitchInstruction;
...
public final class SwitchStatement extends Statement {
  ...
  private SwitchStatement(@NonNull Statement head, @Nullable Statement postStatement) {
    this();
    first = head;
  ...
  @Nullable
  public static Statement isHead(@NonNull Statement head) {
  ...
  @Override
  @NonNull
  public TextBuffer toJava(int indent, @NonNull BytecodeMappingTracer tracer) {
  ...
  public void sortEdgesAndNodes() {
    ...
    List< Statement> caseStatements = new ArrayList<>(stats.size() - 1);
    ...
    List<List< Exprent>> caseValues = new ArrayList<>(edgeIndices.size());
  ...
  private void mapEdgeIndicesToEdges(int[] values,
                                     @NonNull List<List<Integer>> edgeIndices,
                                     @NonNull List<List<StatEdge>> caseEdges,
                                     @NonNull List<List< Exprent>> caseValues) {
  ...
  private void collectRegularEdgesIndices(@NonNull Map<StatEdge, Integer> edgeIndicesMapping,
                                          @NonNull List< Statement> nodes,
                                          @NonNull List<List<Integer>> edgeIndices) {
  ...
  private void collectExitEdgesIndices(@NonNull Map<StatEdge, Integer> edgeIndicesMapping,
                                       @NonNull List< Statement> nodes,
                                       @NonNull List<List<Integer>> edgeIndices) {
  ...
  private void sortEdges(List< Statement> nodes, @NonNull List<List<Integer>> edgeIndices) {
  ...
  private void replaceNullStatementsWithBasicBlocks(List< Statement> statements, @NonNull List<List<StatEdge>> edges) {
