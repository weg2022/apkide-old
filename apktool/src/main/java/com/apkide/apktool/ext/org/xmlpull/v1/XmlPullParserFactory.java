...
package com.apkide.apktool.ext.org.xmlpull.v1;
 ...
 *
 * @see com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser
 *
...
public class XmlPullParserFactory {
    ...
    public void setFeature(String name,
                           boolean state) throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException {
    ...
    public void setNamespaceAware(boolean awareness) {
        features.put (com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser.FEATURE_PROCESS_NAMESPACES, new Boolean (awareness));
    }
    ...
    public boolean isNamespaceAware() {
        return getFeature (com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser.FEATURE_PROCESS_NAMESPACES);
    }
    ...
    public void setValidating(boolean validating) {
        features.put (com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser.FEATURE_VALIDATION, new Boolean (validating));
    }
    ...
    public boolean isValidating() {
        return getFeature (com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser.FEATURE_VALIDATION);
    }
     ...
     * @throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException if a parser cannot be created which satisfies the
     * requested configuration.
     */

    public com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser newPullParser() throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException {

        if (parserClasses == null) throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException
                ("Factory initialization was incomplete - has not tried "+classNamesLocation);

        if (parserClasses.size() == 0) throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException
        ...
        for (int i = 0; i < parserClasses.size (); i++) {
            ...
            try {
                final com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser pp = (com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParser) ppClass.newInstance();
                //            if( ! features.isEmpty() ) {
        ...
        throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException("could not create parser: "+issues);
    }
    ...
    public com.apkide.apktool.ext.org.xmlpull.v1.XmlSerializer newSerializer() throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException {

        if (serializerClasses == null) {
            throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException
        ...
        for (int i = 0; i < serializerClasses.size (); i++) {
            ...
            try {
                final com.apkide.apktool.ext.org.xmlpull.v1.XmlSerializer ser = (com.apkide.apktool.ext.org.xmlpull.v1.XmlSerializer) ppClass.newInstance();
        ...
        throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException("could not create serializer: "+issues);
    }
     ...
     */
    public static XmlPullParserFactory newInstance () throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException {
        return newInstance(null, null);
    }

    public static XmlPullParserFactory newInstance (String classNames, Class context)
        throws com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException {
        ...
        if (classNames == null || classNames.length() == 0 || "DEFAULT".equals(classNames)) {
            try {
                ...
                if (is == null) throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException
                ...
                throw new com.apkide.apktool.ext.org.xmlpull.v1.XmlPullParserException(null, null, e);
            }
