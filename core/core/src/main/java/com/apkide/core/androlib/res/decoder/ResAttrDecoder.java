...
import com.apkide.core.androlib.res.data.ResID;
import com.apkide.core.androlib.res.data.ResPackage;
import com.apkide.core.androlib.res.data.ResResSpec;
import com.apkide.core.androlib.res.data.value.ResAttr;
import com.apkide.core.androlib.res.data.value.ResScalarValue;
...
public class ResAttrDecoder {
    ...
    public String decodeManifestAttr(int attrResId)
        ...
        if (attrResId != 0) {
            ...
            // See also: com.apkide.core.androlib.res.data.ResTable.getResSpec
            if (attrId >> 24 == 0) {
