...
public class smaliParser extends Parser {
	...
	public final smali_file_return smali_file() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: implements_spec, source_spec, class_spec, super_spec, method, field
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					// AST REWRITE
					// elements: nonvoid_type_descriptor, literal, member_name, access_or_restriction_list, annotation
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: member_name, literal, nonvoid_type_descriptor, access_or_restriction_list
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final method_return method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: access_or_restriction_list, member_name, statements_and_directives, method_prototype
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final statements_and_directives_return statements_and_directives() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: parameter_directive, catchall_directive, registers_directive, catch_directive, ordered_method_item
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final call_site_reference_return call_site_reference() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_prototype, method_reference, literal, STRING_LITERAL, simple_name
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final catch_directive_return catch_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: to, nonvoid_type_descriptor, using, from
			// token labels: 
	...
	public final local_directive_return local_directive() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: signature, REGISTER, name, NULL_LITERAL, nonvoid_type_descriptor
	...
	public final insn_format21c_method_handle_return insn_format21c_method_handle() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: method_handle_reference, REGISTER, INSTRUCTION_FORMAT21c_METHOD_HANDLE
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format21c_method_type_return insn_format21c_method_type() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: REGISTER, method_prototype, INSTRUCTION_FORMAT21c_METHOD_TYPE
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format3rc_call_site_return insn_format3rc_call_site() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: register_range, INSTRUCTION_FORMAT3rc_CALL_SITE, call_site_reference
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format45cc_method_return insn_format45cc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: INSTRUCTION_FORMAT45cc_METHOD, register_list, method_prototype, method_reference
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final insn_format4rcc_method_return insn_format4rcc_method() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: register_range, method_reference, INSTRUCTION_FORMAT4rcc_METHOD, method_prototype
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
